...
#    data = IMDBdata("C:/Users/jaide/Documents/NLP/Assignment 1/data/data1/train")
#    print(data.Y)
#    print(data.X)
#    print(data.X[2])
#    print(data.X.shape[0])
#    print(data.X_reviews)
#    array=data.vocab.GetWords()
##    for i in data.X_reviews:
##        print(data.vocab.GetID(i))
##        print(data.vocab.GetWord(data.vocab.GetID(i)))
#    print(data.vocab.GetID("neg"))
#    print(data.vocab.GetID("positive"))
#    print(data.vocab.GetID("fisj"))
#    print(data.vocab)
#    
#    data1 = IMDBdata("C:/Users/jaide/Documents/NLP/Assignment 1/data/data1/test",vocab=data.vocab)
#    print(data1.Y)
#    print(data1.X)
#    print("xaxa",data1.X[:,0])
#    print("qw",data1.X[0])
#    print(data1.X.shape[0])
#    print(data1.X_reviews)
#    array=data1.vocab.GetWords()
##    for i in data.X_reviews:
##        print(data.vocab.GetID(i))
##        print(data.vocab.GetWord(data.vocab.GetID(i)))
#    print(data1.vocab.GetID("neg"))
#    print(data1.vocab.GetID("positive"))
#    print(data1.vocab.GetID("fisj"))